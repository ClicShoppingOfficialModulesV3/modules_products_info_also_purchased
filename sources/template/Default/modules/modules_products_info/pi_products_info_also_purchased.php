...
// **************************
    ...
    public function install() {
      ...
      $CLICSHOPPING_Db->save('configuration', [
          ...
          'configuration_description' => 'Veuillez indiquer le nombre maximum de nouveaux produits &agrave; afficher.',
          'configuration_group_id' => '6',
          'sort_order' => '5',
          'set_function' => '',
          'date_added' => 'now()'
      ...
      $CLICSHOPPING_Db->save('configuration', [
       ...
       $CLICSHOPPING_Db->save('configuration', [
          'configuration_title' => 'Q\'uelle est la largeur des images concernant les produits compl&eacute;mentaires achet&eacute;s ?',
          'configuration_key' => 'MODULE_PRODUCTS_INFO_ALSO_PURCHASED_IMAGE_WIDTH',
          'configuration_value' => '',
          'configuration_description' => 'Veuillez indiquer la largeur des images qui seront affich&eacute;es<br /><br /><strong>Note :</strong><br>Si le champs est vide, la taille de l\'image aura sa taille r&eacute;elle. A d&eacute;faut, elle sera recalcul&eacute;e en fonction de la nouvelle taille ins&eacute;r&eacute;e',
          'configuration_group_id' => '6',
          'sort_order' => '10',
          'set_function' => '',
          'date_added' => 'now()'
      ...
      $CLICSHOPPING_Db->save('configuration', [
          ...
          'configuration_value' => '',
          'configuration_description' => 'Veuillez indiquer la hauteur des images qui seront affich&eacute;es<br /><br /><strong>Note :</strong><br>Si le champs est vide, la taille de l\'image aura sa taille r&eacute;elle. A d&eacute;faut, elle sera recalcul&eacute;e en fonction de la nouvelle taille ins&eacute;r&eacute;e',
          'configuration_group_id' => '6',
          'sort_order' => '11',
          'set_function' => '',
          'date_added' => 'now()'
